...
import * as on_update from "./on_update";
import * as image_right_click_menu from "./image_right_click_menu";


/**
 * On first installation, open the extension's options page so that the
 * user can add their Slack teams.
*/
chrome_extension.onFirstInstall(chrome_extension.openOptionsPage);

/**
 * Register special actions to perform on version update
 */
chrome_extension.onUpdate(on_update.onUpdate);

/**
 * Create the Right-Click Menu buttons on images
*/
image_right_click_menu.createAllButtons();
