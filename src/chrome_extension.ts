...
*/
export const onUpdate = (fn: (previousVersion: Version, currentVersion: Version) => void) => {
    chrome.runtime.onInstalled.addListener(function (details) {
...
export const addRightClickMenuButton = (
    id: string,
    title: string,
    contexts: Array<"all" | "page" | "frame" | "selection" | "link" | "editable" | "image" | "video" | "audio" | "launcher" | "browser_action" | "page_action" | "action">,
